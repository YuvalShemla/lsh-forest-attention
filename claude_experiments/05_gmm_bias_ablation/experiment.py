...
Run from: claude_experiments/05_gmm_bias_ablation/
Results saved to: claude_experiments/05_gmm_bias_ablation/results/
"""
...
def main():
    ...
    print("=" * 70)
    print("EXPERIMENT 5: GMM Bias Source Ablation")
    print("=" * 70)
    ...
    json_results = {
        'metadata': {
            'experiment': 'GMM Bias Source Ablation',
            'clusters': CLUSTERS,
